...
def render_auth_page():
    ...
    _, col2, _ = st.columns([0.8, 1.4, 0.8])
    
    with col2:
        # Simple, elegant logo and header
        st.markdown("""
        <div style="text-align: center; margin-top: 10px; margin-bottom: 20px;">
            <div style="font-size: 3.5rem; margin-bottom: 5px;">🌱</div>
            <h1 style="color: #ffffff; font-size: 2.2rem; font-weight: 800; margin: 0; background: linear-gradient(135deg, #ffffff 0%, #a7f3d0 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Plant Doctor AI</h1>
            <p style="color: rgba(255, 255, 255, 0.75); font-size: 1rem; margin: 5px 0 0 0; font-weight: 500;">Pakistani Kisanon Ka AI Doctor</p>
        </div>
        """, unsafe_allow_html=True)
