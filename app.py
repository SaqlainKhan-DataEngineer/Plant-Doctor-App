...
.slide-track { display: flex; width: calc(600px * 12); animation: scroll 45s linear infinite; }
...
.badge-soon { display: inline-block; background: linear-gradient(90deg, #f59e0b, #ef4444); color: white; padding: 5px 16px; border-radius: 20px; font-size: 0.8rem; font-weight: 700; margin-top: 10px; }
...
<p style="text-align:center;font-size:0.8rem;color:#aaa;margin-top:8px;">🖱️ Hover to pause</p>
""", unsafe_allow_html=True)
