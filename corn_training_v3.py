...
# Corn ka path — same check karo:
DATASET_PATH = r"D:\mega plant dataset\PlantvillageFYP"  # Ya jo bhi sahi path hai
...
def get_aug():
    return A.Compose([
        ...
        A.ShiftScaleRotate(0.1,0.2,45,p=0.7),
...
# ============================================================
print("="*55)
print("CORN v3 — XGBoost + Advanced Features")
print("="*55)
...
sns.heatmap(confusion_matrix(y_test,y_pred),annot=True,fmt='d',
            cmap='YlOrRd',xticklabels=CLASS_NAMES,yticklabels=CLASS_NAMES)
plt.title('Corn — XGBoost v3'); plt.tight_layout()
plt.savefig('corn_v3_confusion_matrix.png',dpi=150); plt.show()
...
joblib.dump({"model":model,"scaler":scaler,"selector":sel,
            ...
            "corn_disease_model_v3.pkl")
print("\n  corn_disease_model_v3.pkl saved!") 